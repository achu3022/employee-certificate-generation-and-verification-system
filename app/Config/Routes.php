...
$routes->get('/public/preview/(:num)', 'Home::preview/$1');
$routes->get('/experience-certificate/generate', 'ExperienceCertificate::generate');
$routes->get('/offer-letter/generate', 'OfferLetterController::generate');
$routes->post('/offer-letter/generate', 'OfferLetterController::generate');
$routes->get('admin/employee/(:num)', 'Admin::employeeDetail/$1');
$routes->post('/admin/document/delete/(:num)', 'Admin::deleteDocument/$1');