...
class Admin extends BaseController
{
    ...
    public function addEmployee()
    {
        ...
        $data = [
            ...
            'start_date' => $this->convertToDbDate($this->request->getPost('start_date')),
            'end_date' => $this->convertToDbDate($this->request->getPost('end_date')),
            'dob' => $this->convertToDbDate($this->request->getPost('dob')),
        ];
        $employeeModel = new \App\Models\EmployeeModel();
    ...
    public function employeeDetail($id)
    {
        ...
        $employeeModel = new \App\Models\EmployeeModel();
        $documentModel = new \App\Models\DocumentModel();
        $offerLetterDetailModel = new \App\Models\OfferLetterDetailModel();
        ...
        // Check if offer letter has been generated
        $offerLetterGenerated = $offerLetterDetailModel->where('employee_id', $id)->first() !== null;
    ...
    public function deleteDocument($docId)
    {
        ...
        // If offer letter was deleted, also delete from offer_letter_details table
        if ($doc['doc_type'] === 'offer_letter') {
            $offerLetterDetailModel = new \App\Models\OfferLetterDetailModel();
            $offerLetterDetailModel->where('employee_id', $doc['employee_id'])->delete();
        }
